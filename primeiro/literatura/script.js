function machado(){
    const button = document.getElementById("machado-button")
...
function jesus_funcionapfv() {
    const button = document.getElementById("jesus-button")
...
function conceicao() {
    const button = document.getElementById("conceicao-button")
...
function saci() {
    const button = document.getElementById("saci-button")
